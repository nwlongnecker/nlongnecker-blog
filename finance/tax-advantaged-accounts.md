...
Additionally, there is nothing preventing you from having both or switching later. You can hold both types of accounts simultaneously and change whether you are contributing to a Traditional or a Roth each year (or do some contributions to Traditional and others to Roth), as long as the total contributions between them does not exceed the contribution limit for each type of account (401k and IRA).
